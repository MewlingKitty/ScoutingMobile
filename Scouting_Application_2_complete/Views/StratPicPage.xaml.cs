...
using Scouting_Application_2_complete.Behaviors;
using Scouting_Application_2_complete.Helpers;
using Scouting_Application_2_complete.Services.Ink;
...
namespace Scouting_Application_2_complete.Views
{
    ...
    public sealed partial class StratPicPage : Page, INotifyPropertyChanged
    {
